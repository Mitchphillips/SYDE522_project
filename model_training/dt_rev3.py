...
# use the resampled data as the training and test data
...
DT = tree.DecisionTreeClassifier(criterion="entropy",splitter="best",max_depth=13)
...
#   # initialize classifier
#   DT = tree.DecisionTreeClassifier(criterion="gini",splitter="best",max_depth=depth)
